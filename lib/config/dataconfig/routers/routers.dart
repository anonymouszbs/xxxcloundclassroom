...
import 'package:xxxcloundclassroom/pages/reader/LoadOther.dart';
...
class Routers{
  ...
  static List<GetPage> _normalGroupRoutes(){
    return [
     ...
     GetPage(name: PageIdConfig.readerbookpage, page: ()=> const ReaderBookPage()),
      GetPage(name: PageIdConfig.videoplay, page: ()=> const VideoPlayScreen()),
      GetPage(name: PageIdConfig.loadOhter, page: ()=>const LoadOther())
    ];
  }
}